# CryptoPals Python Solutions / Set 1 / Solution 4
# Challenge in 04-detect-single-character-xor.md .
#
# For every ciphertext _and_ every possible key, decrypt the ciphertext and chi-square test the candidate. Whichever
# candidate had the lowest chi-squared value is the most likely plaintext. It might not actually be English, but this is
# good enough! More at http://practicalcryptography.com/cryptanalysis/text-characterisation/chi-squared-statistic/ .
...
def main():
    ...
    print(plaintext_candidate.decode().rstrip())
